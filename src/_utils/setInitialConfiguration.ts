import { default as MxGraph,  mxEdgeHandler,  mxUndoableEdit, StyleMap } from "mxgraph";
...
export default function setInitialConfiguration(
    ...
    // var isForceRubberBandEvent = mxRubberband.arguments.;
    ...
    try {
        ...
        graph.connectionHandler.addListener(mxEvent.CONNECT, function (sender: any, evt: { getProperty: (arg0: string) => any; }) {
